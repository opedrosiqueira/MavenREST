...
public class UserDAO {
    ...
    public User getUserByEmail(String email) {
        try {
            return (User) em.createQuery("SELECT u from User u WHERE u.email = ?1").setParameter(1, email)
                    .getSingleResult();
    ...
    public List<User> search(String termo, String valor) {
        ...
        if (termo.equals("id")) {
            ...
            query = em.createQuery("SELECT u FROM User u WHERE u." + termo + " LIKE ?1", User.class);
